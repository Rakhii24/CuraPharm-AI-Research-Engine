...
_SYNONYM_CLUSTERS: List[Tuple[str, ...]] = [
    ...
    ("supply", "chain", "logistics", "distribution", "inventory", "warehouse", "procurement", "forecasting", "demand", "traceability", "cold"),
    ("commercial", "commercialization", "sales", "marketing", "pricing", "reimbursement", "market", "payer", "launch", "revenue"),
    ("enterprise", "support", "governance", "infrastructure", "training", "human", "resources", "shared", "services", "corporate"),
    ("stability", "shelf", "life", "degradation", "storage", "testing", "chamber", "temperature"),
    ("review", "inspection", "APQR", "PQR", "annual", "audit", "assessment"),
    ("medical", "affairs", "publication", "MSL", "outcomes", "communication"),
